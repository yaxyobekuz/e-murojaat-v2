// Loads the Google Maps JS API bootstrap once, then resolves the maps3d + marker
// libraries. Photorealistic 3D Maps (Map3DElement) require the `alpha` channel.
...
const injectBootstrap = (apiKey) => {
  ...
  bootstrapPromise = new Promise((resolve, reject) => {
    ...
    // Official inline loader (https://developers.google.com/maps/documentation/javascript/load-maps-js-api)
    ((g) => {
      let h;
      let a;
...
// Returns { Map3DElement, Marker3DInteractiveElement, ... } once loaded.
