...
// Qamrov statistikasi (participants/mentors/centers) — Sarnovul MFY kesimida (1 055 yosh).
...
export const PROJECT_DETAILS = {
  "ibrat-farzandlari": {
    ...
    outcomes: [
      { label: "Bitiruvchi", value: "38" },
      { label: "Til yo'nalishi", value: "4 ta" },
  ...
  "ustoz-ai": {
    ...
    outcomes: [
      ...
      { label: "Faol o'quvchi", value: "5" },
      { label: "Yo'nalish", value: "3 ta" },
    ],
  ...
  uzcombinator: {
    ...
    outcomes: [
      { label: "Akseleratsiya", value: "2 startap" },
      { label: "Jalb etilgan", value: "180 mln so'm" },
      { label: "Mentor", value: "1 ta" },
    ],
  ...
  uzchess: {
    ...
    outcomes: [
      { label: "O'quvchi", value: "24" },
      { label: "Video dars", value: "1200+" },
      { label: "Markaz", value: "1 ta" },
    ],
  ...
  "it-akademiya": {
    ...
    outcomes: [
      { label: "Ro'yxatdan o'tgan", value: "7" },
      { label: "Yo'nalish", value: "3 ta" },
      { label: "Coursera litsenziya", value: "4 ta" },
    ],
  ...
  "yoshlar-daftari": {
    ...
    outcomes: [
      { label: "Hozir daftarda", value: "0" },
      { label: "Daftardan chiqarilgan", value: "42" },
      { label: "Qamrov", value: "14 ko'cha" },
    ],
  ...
  "5-tashabbus": {
    ...
    outcomes: [
      { label: "Qamrov", value: "830" },
      { label: "Yo'nalish", value: "5 ta" },
      { label: "To'garak", value: "12 ta" },
    ],
  ...
  "talaba-talim-grant": {
    ...
    outcomes: [
      { label: "Grant egasi", value: "3" },
      { label: "Xalqaro olimpiada", value: "1 g'olib" },
      { label: "Chet el granti", value: "1" },
    ],
  ...
  "yosh-tadbirkor": {
    ...
    outcomes: [
      { label: "Tinglovchi", value: "8" },
      { label: "Mikrogrant", value: "2 loyiha" },
      { label: "Mentor", value: "1 ta" },
    ],
  ...
  "ijod-maktabi": {
    ...
    outcomes: [
      { label: "O'quvchi", value: "14" },
      { label: "Portfolio", value: "9 ta" },
      { label: "Markaz", value: "1 ta" },
    ],
