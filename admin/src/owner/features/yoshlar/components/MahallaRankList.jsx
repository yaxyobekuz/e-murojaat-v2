      ...
      <div className="soliq-scroll flex min-h-0 flex-1 flex-col gap-0.5 overflow-y-auto p-1.5">
        {sorted.map((m, i) => {
          ...
          return (
            ...
            >
              <span className="w-4 shrink-0 text-center text-[11px] font-medium text-foreground/35">{i + 1}</span>
              <span
              ...
              <span className="min-w-0 flex-1">
                <span className="block truncate text-[13px] font-medium text-foreground">{m.shortName}</span>
