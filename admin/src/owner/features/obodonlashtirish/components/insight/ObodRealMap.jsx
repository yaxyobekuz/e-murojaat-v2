...
export const ObodRealMap = ({ accent = "#22c55e", height = 340, showGreen = false, plantings = null, markers = null, zones = null, buildings = null, bare = false, range, label, legend }) => {
  const [activeId, setActiveId] = useState(null);
  return (
    <div className="relative w-full overflow-hidden rounded-xl border" style={{ height, borderColor: hexA(accent, 0.2) }}>
      <ObodMapBackground showGreen={showGreen} activeId={activeId} onSelect={setActiveId} plantings={plantings} markers={markers} zones={zones} buildings={buildings} bare={bare} range={range} />
