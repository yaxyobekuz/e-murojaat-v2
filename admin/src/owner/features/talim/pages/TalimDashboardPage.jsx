...
const MAP3D_MARKERS = [
  ...
  { lat: 40.6385, lng: 72.2405, label: "Kamera — Maktab hovlisi", status: "Jonli efir" },
  { lat: 40.6371, lng: 72.2362, label: "Bog'cha №18", status: "Davomat 94%" },
  { lat: 40.6418, lng: 72.2418, label: "Xususiy maktab", status: "Davomat 96%" },
  { lat: 40.636, lng: 72.239, label: "Sport zali", status: "Faol" },
];
