...
.tcc-scan>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:50% 24%;filter:grayscale(.22) contrast(1.06) saturate(.8) brightness(.96)}
.tcc-scan .vig{position:absolute;inset:0;pointer-events:none;background:radial-gradient(94% 80% at 50% 33%, rgba(5,8,13,0) 30%, rgba(5,8,13,.5) 62%, rgba(5,8,13,.97) 100%)}
