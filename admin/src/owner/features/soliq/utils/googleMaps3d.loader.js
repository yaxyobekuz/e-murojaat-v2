// Loads the Google Maps bootstrap once (alpha channel), then resolves the maps3d
// library used for the Photorealistic 3D soliq map + extruded coloured polygons.
