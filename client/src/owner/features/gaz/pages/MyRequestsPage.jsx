...
import { useMyRequests } from "../hooks/useGazAccount";
import StatusBadge from "../components/StatusBadge";
import RequestTimeline from "../components/RequestTimeline";
import { SERVICE_TYPE_LABELS } from "../constants/gaz.ui";
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6">
      <div className="mb-5 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight">Arizalarim</h1>
          <p className="mt-1 text-sm text-zinc-500">Yuborilgan arizalar va ularning holati</p>
        </div>
        <Link to="/owner/gaz/ariza">
          <Button>
              ...
              <Card key={r._id} className="!p-0">
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 text-xs text-zinc-400">{formatDateUz(r.createdAt)}</p>
                  </div>
                  <ChevronDown
